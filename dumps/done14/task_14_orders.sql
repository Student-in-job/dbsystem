...
CREATE TABLE orders (
  ...
  KEY new_customeronorders1 (customer_id),
  KEY new_employeesonorders1 (employee_id),
  KEY new_orderstatus1 (status_id),
  CONSTRAINT new_customeronorders1 FOREIGN KEY (customer_id) REFERENCES customers (id),
  CONSTRAINT new_employeesonorders1 FOREIGN KEY (employee_id) REFERENCES employees (id),
  CONSTRAINT new_orderstatus1 FOREIGN KEY (status_id) REFERENCES orders_status (status_id)
);
...
INSERT INTO orders VALUES (32,4,12,'2006-01-22','123 12th street','las vegas','credit card',3);
