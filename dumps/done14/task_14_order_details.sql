...
CREATE TABLE order_details (
  ...
  PRIMARY KEY (id),
  KEY new_orderdetails1 (order_id),
  KEY new_productsonorders1 (product_id),
  CONSTRAINT new_orderdetails1 FOREIGN KEY (order_id) REFERENCES orders (order_id) ON DELETE CASCADE,
  CONSTRAINT new_productsonorders1 FOREIGN KEY (product_id) REFERENCES products (id)
);
