        ...
        <div class="row centered registration">
            <div class="col col-4">
                ...
                <form id="form" class="form" action="" method="POST">
                    ...
                    <input type="hidden" name="group" value="${task.list.id}"> 
                    ...
                    <div class="form-item sql-teatarea">
                        <label>Answer Query:</label> <a target="blank" href="${pageContext.request.contextPath}/admin/DataBaseManager.jsp?group=${task.list.id}">DataBase Manager -></a>
