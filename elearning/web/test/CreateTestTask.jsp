...
if(request.getMethod().equals("GET")){
    if(0!=testtask){
        ...
        }catch(ObjectNotFind ex){Log.Write(ex.getLocalizedMessage());; response.sendRedirect("/elearning/Error.jsp?e=ObjectNotFind"); return;}
        catch(Exception ex){Log.Write(ex.getLocalizedMessage());; response.sendRedirect("/elearning/Error.jsp"); return;}
