        ...
        <div class="row centered registration">
            <div class="col col-4">
                ...
                <form id="form" action="" method="post" class="form" enctype="multipart/form-data">
                    ...
                    <div class="form-item">
                        <label>Email</label>
                        <input class="width-100" type="email" name="mail" value="${stud.mail}" required>
                    </div>

                    <div class="form-item">
                        <label>Name</label>
                        <input class="width-100" name="name" type="text" value="${stud.name}" required >
                    </div>

                    <div class="form-item">
                        <label>Surname</label>
                        <input class="width-100" name="surname" type="text" value="${stud.surname}" required >
                    </div>
