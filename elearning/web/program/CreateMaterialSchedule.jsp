...
<%}
        if(request.getMethod().equals("POST")){
            ...
            while(name.hasMoreElements()){
                ...
                days.put(Integer.parseInt(key), form2.parse(value));
            }
            Integer []k = days.keySet().toArray(new Integer[1]);
            ...
            if(err){response.sendError(500, "Нарушен порядок дней или длина курса");}
            else{
