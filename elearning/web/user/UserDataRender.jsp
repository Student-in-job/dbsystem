        ...
        <div class=userbar>
            ...
            <div class="row userbar-1">
                <div class="col col-3 text-right">
                    <img src="${pageContext.request.contextPath}/<%=user.getIco()%>" alt="" class="img-circle">
                </div>
                <div class="col col-3">
                    <br>
                    <p>
                ...
                <div class="col text-center"> 
                    <br>
                    <br>
                    <a class="button round outline" href="${pageContext.request.contextPath}/UserSettings.jsp">Settings &rarr;</a>
                </div>
            </div>
...
<%for(int i=0; i<created_program.size(); i++) {%>  
                <p>
                    <a href="${pageContext.request.contextPath}/Course.jsp?course_id=<%=created_program.get(i).getID()%>"><%=created_program.get(i).getName()%></a>
                </p>                
<%}%>                                               
                            </div>
...
<%for(int i=0; i<activ_program.size(); i++) {%>  
                <p>
                    <a href="${pageContext.request.contextPath}/Course.jsp?course_id=<%=activ_program.get(i).getID()%>"><%=activ_program.get(i).getName()%></a>
                </p>                
<%}%>                                               
                            </div>
