...
static String sqlisExist = "select * from users where mail = ?;";
static String sqlset_information = "insert into users(mail, password, user_name, user_surname, birthday, gender, date_reg)  values (?, ?, ?, ?, ?, ?, now());";
