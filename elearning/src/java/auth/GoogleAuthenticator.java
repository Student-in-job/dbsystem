...
public class GoogleAuthenticator {
 ...
 static public String getSecretKey(int user){
     String key =null;
     try{
 ...
 static public void putSecretKey(int user, String key){
     try{
            PreparedStatement stmt = db.getConn().prepareStatement("insert into users_key (user, secret_key) values (?, ?);");
            stmt.setInt(1, user);
